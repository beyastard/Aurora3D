...
public:
    ...
    bool Open(std::string_view folderName, std::string_view fileName, unsigned int flags) override;
    bool Open(std::string_view fullPath, unsigned int flags) override;
...
protected:
    bool Init(std::string_view fullPath);
    bool Release();
